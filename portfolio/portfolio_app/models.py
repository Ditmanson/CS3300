...
class Student(models.Model):
    ...
    # List choices for Major value in database, human readable name
    MAJOR = (
        ...
        ('DASE-BS', 'BS in Data Analytics and Software Engineering'),          
    )
    name = models.CharField(max_length=200)
    email = models.EmailField("UCCS Email", max_length=200)
...
class Portfolio(models.Model):
    ...
    contact_email = models.EmailField("Contact Email", max_length=200)
